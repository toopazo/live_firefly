...
MAV_TYPE_VTOL_TAILSITTER_DUOROTOR = 19 # Two-rotor Tailsitter VTOL that additionally uses control surfaces in
...
MAV_TYPE_VTOL_TAILSITTER_QUADROTOR = 20 # Quad-rotor Tailsitter VTOL using a V-shaped quad config in vertical
...
MAV_TYPE_VTOL_TILTROTOR = 21 # Tiltrotor VTOL. Fuselage and wings stay (nominally) horizontal in all
                        # flight phases. It able to tilt (some) rotors
                        # to provide thrust in cruise flight.
...
MAV_TYPE_VTOL_FIXEDROTOR = 22 # VTOL with separate fixed rotors for hover and cruise flight. Fuselage
                        # and wings stay (nominally) horizontal in all
                        # flight phases.
...
MAV_TYPE_VTOL_TAILSITTER = 23 # Tailsitter VTOL. Fuselage and wings orientation changes depending on
                        # flight phase: vertical for hover, horizontal
                        # for cruise. Use more specific VTOL
                        # MAV_TYPE_VTOL_DUOROTOR or
